...
class TeamMessage(Writer):
    ...
    def encode(self):
        ...
        # MapID
        self.writeScId(15, self.player.mapID)
        ...
        for x in range(1):
            ...
            self.writeScId(16, self.player.homeBrawler)  # BrawlerID
            self.writeScId(29, self.player.homeSkin)     # SkinID
            ...
            self.writeScId(23, self.player.starpower) # StarpowerID
            self.writeScId(23, self.player.gadget)    # GadgetID
